...
export default function Sidebar() {
  ...
  return (
    <>
      <aside className="flex flex-col w-[215px] shrink-0 bg-white dark:bg-slate-950 border-r border-slate-200/80 dark:border-slate-800/90 text-slate-600 dark:text-slate-300 h-screen sticky top-0 overflow-y-auto select-none font-sans text-xs">
